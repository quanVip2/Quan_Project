...
class SignUpDateOfBirthScreenGG extends StatefulWidget {
  final String idToken;
  const SignUpDateOfBirthScreenGG({super.key, required this.idToken});

  @override
  State<SignUpDateOfBirthScreenGG> createState() =>
      _SignUpDateOfBirthScreenState();
}

class _SignUpDateOfBirthScreenState extends State<SignUpDateOfBirthScreenGG> {
  int _selectedDay = 1;
  ...
  Widget build(BuildContext context) {
    ...
    print("ID Token: ${widget.idToken}"); // Log idToken tại đây
            ...
            Center(
              child: ElevatedButton(
                ...
                onPressed: () {
                  ...
                  // Đảm bảo idToken được truyền đúng
                  print(
                      "Passing ID Token to next screen: ${widget.idToken}"); // Log khi chuyển sang màn hình tiếp theo

                  Navigator.pushNamed(context, '/signup_gender_gg',
